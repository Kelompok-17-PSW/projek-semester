...
const SimplePast = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="container">
        <h1>📖 Past Perfect Tense Formula</h1>
        <table>
          <thead>
            <tr>
      ...
      <section className="activity-section">
        <h2>Activity</h2>
        <p>Rewrite the following sentences using past perfect tense.</p>
        <div className="word-list">
          ...
          <div className="word-card">
            ...
            <p className="word-meaning">
              We ... (not / expect) to arrive so early at the station.
            </p>
            <input
              type="text"
              ref={answer7Ref}
          ...
          <div className="word-card">
            <h3 className="word-title exhausted">Question 8</h3>
            <p className="word-meaning">
              He ... (close) the door before anyone noticed.
            </p>
            <input
              type="text"
              ref={answer8Ref}
          ...
          <div className="word-card">
            <h3 className="word-title aim">Question 9</h3>
            <p className="word-meaning">
              They ... (go) to the restaurant by the time we arrived.
            </p>
            <input
              type="text"
              ref={answer9Ref}
          ...
          <div className="word-card">
            <h3 className="word-title giggle">Question 10</h3>
            <p className="word-meaning">
              I ... (see) the movie before I heard the story.
            </p>
            <input
              type="text"
              ref={answer10Ref}
