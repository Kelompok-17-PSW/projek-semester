...
const SimplePast = () => {
  ...
  const correctAnswers = {
    ...
    answer7: "had been running",
    answer8: "had been suggesting",
    answer9: "had been studying",
    answer10: "had been waiting",
  };
  ...
  const handleSubmit = () => {
    const answers = {
      ...
      answer9: answer9Ref.current.value.trim(),
      answer10: answer10Ref.current.value.trim(),
    };
  ...
  return (
    <div className="container">
      ...
      <div className="container">
        <h1>📖 Past Perfect Continuous Tense Formula</h1>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td>(+) Positive </td>
              <td>Subject + had + been + present participle + the rest of the sentence</td>
              <td>
                - I had been cooking my mom’s favourite dish when she walked into the kitchen.<br/>
            ...
            <tr>
              <td>(-) Negative</td>
              <td>Subject + had + not + been + present participle + the rest of the sentence</td>
              <td>
                - We hadn't been living there long.<br/>
            ...
            <tr>
              <td>(?) Interrogative</td>
              <td>Had + subject + been + present participle + the rest of the sentence<br/>
              <b>Negative Interrogative:</b> Had + subject + not + been + present participle + the rest of the sentence<br/>
              (or)<br/>
              Hadn’t + subject + been + present participle + the rest of the sentence
              </td>
              <td>
                - Had the pilot been drinking before the crash?<br/>
      ...
      <section className="section info-section">
        ...
        <div className="content">
          ...
          <p>
            Similar to the present perfect continuous tense, the past perfect continuous tense also consists of two helping verbs and a main verb. 
            ...
            This rule holds true when the sentence is a positive sentence. In case you are employing the tense form in an interrogative sentence, the helping verb ‘had’ comes first followed by the subject which is in turn followed by the helping verb ‘been’ and the present participle of the main verb. 
      ...
      <section className="section info-section">
        ...
        <div className="content">
          ...
          <p>
            The past perfect continuous tense is used to perform two main functions. They are: <br/>
      ...
      <section className="activity-section">
        <h2>Activity</h2>
        <p>
          Rewrite the following sentences using past perfect tense.
        </p>
        <div className="word-list">
          ...
          <div className="word-card">
            <h3 className="word-title expert">Question 9</h3>
            <p className="word-meaning">
              Before her interview, she ... (study) the key components of the software.
            </p>
            <input
              type="text"
              ref={answer9Ref}
          ...
          <div className="word-card">
            <h3 className="word-title new">Question 10</h3>
            <p className="word-meaning">
